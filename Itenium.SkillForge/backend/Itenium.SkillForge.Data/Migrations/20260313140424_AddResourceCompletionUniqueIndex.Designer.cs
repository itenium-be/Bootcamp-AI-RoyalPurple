...
namespace Itenium.SkillForge.Data.Migrations
{
    ...
    [Migration("20260313140424_AddResourceCompletionUniqueIndex")]
    partial class AddResourceCompletionUniqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Itenium.SkillForge.Entities.FeedbackCommentEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Itenium.SkillForge.Entities.UserActivityEntity", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)");
            ...
            modelBuilder.Entity("Itenium.SkillForge.Entities.FeedbackCommentEntity", b =>
                {
                    b.HasOne("Itenium.SkillForge.Entities.FeedbackEntity", "Feedback")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Itenium.SkillForge.Entities.ResourceCompletionEntity", b =>
                {
                    b.HasOne("Itenium.SkillForge.Entities.CourseResourceEntity", "Resource")
                        .WithMany()
