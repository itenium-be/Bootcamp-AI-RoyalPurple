...
namespace Itenium.SkillForge.Data.Migrations
{
    ...
    [Migration("20260313120000_AddGoalLinkedResources")]
    partial class AddGoalLinkedResources
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Itenium.SkillForge.Entities.GoalEntity", b =>
                {
                    ...
                    b.Property<string>("CreatedByCoachId")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.Property<string>("LinkedResources")
                        .HasColumnType("text");

                    b.Property<DateTime?>("ReadinessFlagRaisedAt")
                        .HasColumnType("timestamp with time zone");
