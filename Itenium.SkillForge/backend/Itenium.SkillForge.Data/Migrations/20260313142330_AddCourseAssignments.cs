        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedById = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseAssignments_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseAssignments_TeamId",
                table: "CourseAssignments",
                column: "TeamId");
        }
